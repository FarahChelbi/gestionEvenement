				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<h2>Welcome to EventEcho</h2>
							<p>This website is for generating events </p>
						</div>
					</section>
						...
						<!-- One -->
							<section id="one" class="wrapper spotlight style1">
								<div class="inner">
									...
									<div class="content">
										<h2 class="major">Discover Our Purpose </h2>
                                        <p>Our mission is to make event discovery a breeze by generating and curating a wide range of events from across the globe. Whether you're searching for the hottest concerts, the trendiest art exhibitions, or the most happening community gatherings, we've got you covered. Join us in exploring a world of endless possibilities and stay up-to-date with the newest events that matter most to you."</p>
