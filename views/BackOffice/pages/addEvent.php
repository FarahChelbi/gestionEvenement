        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="titre" id="titre" class="form-control" placeholder="Enter the title of the event" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="dateevent">Date</label>
                    <input type="date" name="dateevent" id="dateevent" class="form-control" placeholder="Enter the date" required>
                </div>
            </div>
        </div>
